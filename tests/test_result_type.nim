...
suite "Test result types":
  test "Test Boolean result type":
    ...
    discard conn.executeMaterialized("CREATE TABLE booleans(i BOOLEAN);")
    discard conn.executeMaterialized(
      "INSERT INTO booleans VALUES (true), (false), (true);"
    )
    let r = conn.executeMaterialized("SELECT * FROM booleans")
    for chunk in r:
  ...
  test "Test TinyInt result type":
    ...
    let r = conn.executeMaterialized("SELECT * FROM tinyints")
    for chunk in r:
  ...
  test "Test SmallInt result type":
    ...
    let r = conn.executeMaterialized("SELECT * FROM smallints")
    for chunk in r:
  ...
  test "Test Integer result type":
    ...
    let r = conn.executeMaterialized("SELECT * FROM integers")
    for chunk in r:
  ...
  test "Test BigInt result type":
    ...
    let r = conn.executeMaterialized("SELECT * FROM bigints")
    for chunk in r:
  ...
  test "Test UTinyInt result type":
    ...
    let r = conn.executeMaterialized("SELECT * FROM utinyints")
    for chunk in r:
  ...
  test "Test USmallInt result type":
    ...
    let r = conn.executeMaterialized("SELECT * FROM usmallints")
    for chunk in r:
  ...
  test "Test UInteger result type":
    ...
    let r = conn.executeMaterialized("SELECT * FROM uintegers")
    for chunk in r:
  ...
  test "Test UBigInt result type":
    ...
    let r = conn.executeMaterialized("SELECT * FROM ubigints")
    for chunk in r:
  ...
  test "Test Float result type":
    ...
    let r = conn.executeMaterialized("SELECT * FROM floats")
    for chunk in r:
  ...
  test "Test Date result type":
    let conn = newDatabase().connect()
    discard conn.executeMaterialized("CREATE TABLE IF NOT EXISTS dates (dt DATE);")
    discard conn.executeMaterialized("INSERT INTO dates VALUES ('1992-09-20')")
    let r = conn.executeMaterialized("SELECT * FROM dates")
    for chunk in r:
      check chunk.bindAs(0, DuckType.Date)[0].year == 1992

  test "Test Time result type":
    let conn = newDatabase().connect()
    discard conn.executeMaterialized("CREATE TABLE IF NOT EXISTS times (tm TIME);")
    discard conn.executeMaterialized("INSERT INTO times VALUES ('01:02:03')")
    let r = conn.executeMaterialized("SELECT * FROM times")
    for chunk in r:
  ...
  test "Test HugeInt result type":
    ...
    let r = conn.executeMaterialized("SELECT * FROM huge")
    for chunk in r:
  ...
  test "Test Varchar result type":
    ...
    let r = conn.executeMaterialized("SELECT * FROM varchars")
    for chunk in r:
      check chunk.bindAs(0, DuckType.Varchar).toSeq == @["foo", "bar", "baz"]

  test "Test Blob result type":
    let conn = newDatabase().connect()
    let r = conn.executeMaterialized("SELECT 'AB'::BLOB;")
    for chunk in r:
  ...
  test "Test Decimal result type":
    ignoreLeak:
      let conn = newDatabase().connect()
      let r = conn.executeMaterialized("SELECT CAST(12.3456 AS DECIMAL);")
      for chunk in r:
